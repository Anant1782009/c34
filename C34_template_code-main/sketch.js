...
function setup() 
{
  ...
  star_show = createSprite(50,20)
  star_show.scale = 0.2
  star_show.addAnimation('empty' , emptyimg)
  star_show.addAnimation('onefill' , oneStar)
  star_show.addAnimation('twofill' , twoStarimg)
  star_show.changeAnimation('empty')
  ...
  ballon2.position(250,360)
  ballon2.size(120,120)
  ballon2.mouseClicked(air_blow)
...
fruit=null;
   ...
   if(collide(fruit , star , 20)===true){
     star.visible = false
     star_show.changeAnimation('onefill')
   }

   if(collide(fruit , star2 , 20)===true){
    star2.visible = false
    star_show.changeAnimation('twofill')
  }
}
